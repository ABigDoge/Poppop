// generated by /home/delirio/Documents/c_work/Poppop/scripts/ddl2cpp /home/delirio/Documents/c_work/Poppop/temp/Poppop3.ddl /home/delirio/Documents/c_work/Poppop/Service/MyTable myname
#ifndef MYNAME_MYTABLE_H
#define MYNAME_MYTABLE_H
...
#include <sqlpp11/char_sequence.h>
  ...
  namespace PrivateMessage_
  {
    ...
    struct RecverID
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "Recver_ID";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T RecverID;
            T& operator()() { return RecverID; }
            const T& operator()() const { return RecverID; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::can_be_null>;
    };
  ...
  struct PrivateMessage: sqlpp::table_t<PrivateMessage,
               PrivateMessage_::SenderID,
               PrivateMessage_::Context,
               PrivateMessage_::MessageType,
               PrivateMessage_::MessageTime,
               PrivateMessage_::RecverID,
               PrivateMessage_::IsDelete>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "PrivateMessage";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
        T PrivateMessage;
        T& operator()() { return PrivateMessage; }
        const T& operator()() const { return PrivateMessage; }
      };
    };
  };
  namespace PublicMessage_
  {
    struct SenderID
    {
      struct _alias_t
  ...
  struct PublicMessage: sqlpp::table_t<PublicMessage,
               PublicMessage_::SenderID,
               PublicMessage_::Context,
               PublicMessage_::MessageType,
               PublicMessage_::MessageTime,
               PublicMessage_::GroupID,
               PublicMessage_::IsDelete>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "PublicMessage";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
        T PublicMessage;
        T& operator()() { return PublicMessage; }
        const T& operator()() const { return PublicMessage; }
      };
    };
  };
  namespace User_
